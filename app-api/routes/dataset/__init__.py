...
from routes.dataset.policy_check.streaming import router as policy_check_streaming_router
...
dataset.include_router(policy_check_router)
dataset.include_router(policy_check_streaming_router)
