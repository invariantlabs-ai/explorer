...
export function ConsentBanner() {
  const [consent, _setConsent] = useState(
  ...
  return (
    <div className="consent-banner">
      <p>
        We use cookies for analytics to understand usage of our site using{" "}
        <em>
      ...
      {!expanded && (
        <pre className="highlight" onClick={() => setExpanded(true)}>
      ...
      {expanded && (
        <pre>
          ...
          <ul>
            <li>
              Freely given: Your consent to our cookies is optional, and you are
              free to use our site without cookies by not clicking "Accept".
            </li>
            <li>
              Informed choice: For analytics with PostHog, your data is
              anonymized where possible and used solely for product improvement.
            </li>
            <li>
              Withdraw: You may withdraw or modify your consent at any time by
              clicking the Cookie Controls link in the sidebar of our site.
            </li>
          </ul>
          Special conditions for children under 13: Consent must be given by a
          parent or guardian. We keep a record of your consent. For details on
          how we handle data, please view our full{" "}
